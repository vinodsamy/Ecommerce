    ...
    <FormContainer>
      ...
      <Form onSubmit={submitHandler}>
        <Form.Group controlId="name">
          ...
          <Form.Control type="name" placeholder="Enter the name" onChange={(e) => setName(e.target.value)}></Form.Control>
        </Form.Group>
        ...
        <Form.Group controlId="confirmPassword">
          ...
          <Form.Control type="password" placeholder="Enter confirmPassword" onChange={(e) => setConfirmPassword(e.target.value)}></Form.Control>
        </Form.Group>
